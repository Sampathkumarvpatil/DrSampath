...
const Achievements = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      year: "2023",
      description: "Developed world's first AI Meeting Superagent",
  ...
  const worldRecordDetails = {
    title: "World Record in AI-Assisted Content Creation",
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="bg-primary-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3 text-primary-700">Verification & Recognition</h4>
                <ul className="space-y-2">
                  {worldRecordDetails.recognitions.map((rec, index) => (
